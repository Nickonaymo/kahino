...
def print_receipt(selected_items):
    ...
    # Add header to the receipt content
    ...
    # Add subtotal, delivery charge, and total to the receipt content
    ...
    # Add list of items to the receipt content
...
def display_chosen_items():
    ...
    place_order = Button(dash_board,
            ...
            font=('Arial', 15, 'bold'),
            border=0,
            command=lambda: place_order(selected_items)
         )
    ...
    if user_input in accounts:
        ...
        if pass_input == account_password:
            ...
            if role == "admin":
                ...
                display_chosen_items()  # Staff dashboard
...
def login_display():
    ...
    forgot_password_button = Button(login_frame, width=20, text='Forgot Password?', border=0, bg='light gray',
                                    font=('Arial', 8), cursor='hand2', fg='#DB7921')
